...
### 🐛 Bug fix  
### ✈️ Improvements  
- This release includes updates from the underlying [Framework v1.3.0](https://docs.infinilabs.com/framework/v1.3.0), which resolves several common issues and enhances overall stability and performance. While there are no direct changes to Agent itself, the improvements inherited from Framework benefit Agent indirectly.
...
### 🐛 Bug fix  
### ✈️ Improvements  
- This release includes updates from the underlying [Framework v1.1.9](https://docs.infinilabs.com/framework/v1.1.9), which resolves several common issues and enhances overall stability and performance. While there are no direct changes to AGENT itself, the improvements inherited from Framework benefit AGENT indirectly.
