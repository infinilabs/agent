...
### 🐛 Bug fix  
### ✈️ Improvements  
- This release includes updates from the underlying [Framework v1.1.8](https://docs.infinilabs.com/framework/v1.1.8), which resolves several common issues and enhances overall stability and performance. While there are no direct changes to AGENT itself, the improvements inherited from Framework benefit AGENT indirectly.
