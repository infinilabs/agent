...
func InitAPI() {
	...
	api.HandleAPIMethod(api.POST, "/elasticsearch/nodes/logs/_list", agentAPI.getElasticLogFiles)
	api.HandleAPIMethod(api.POST, "/elasticsearch/nodes/logs/_read", agentAPI.readElasticLogFile)
